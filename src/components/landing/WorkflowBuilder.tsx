...
/**
 * Replaces the old "Reality today" section. Strikes a line through
 * "Workflow Builder" and pairs it with the new replacement promise:
 * an AI that learns from a one-time demo or a single answered
 * question. Two visuals sit side by side, each with one caption line.
 */
        ...
        <section className="w-full bg-background-warm border-t border-divider min-w-xs">
            <div className="mx-auto max-w-[1280px] px-4 md:px-8 py-20 md:py-28">
                <h2 className="duri-section-title">
                    <span className="line-through text-on-background-secondary/60 decoration-on-background-secondary/60 decoration-[0.06em] mr-3 md:mr-5">
                        Workflow Builder.
                    </span>
                    <span>AI that learns from you.</span>
                </h2>
                <p className="mt-5 text-[16px] md:text-[18px] text-on-background-secondary max-w-xl">
                    Show the work once. The workspace remembers.
                </p>
                ...
                <div className="mt-14 md:mt-20 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
                    <figure className="flex flex-col gap-5">
                        ...
                        <figcaption className="text-[15px] md:text-[16px] text-on-background leading-snug">
                            Demo the work in your browser, once.
                        </figcaption>
                    </figure>
...
/** Trimmed version of the old recording visual. */
function BrowserDemoVisual() {
    return (
        <div className="border border-on-background rounded-xs bg-background overflow-hidden shadow-[0_18px_36px_-24px_rgba(0,50,32,0.18)]">
            ...
            <div className="relative h-[210px] bg-background overflow-hidden px-5 pt-5 pb-5">
...
/** Asking-user clarification widget, paired with a cursor that lands
 *  on the suggested option and a small "you answered" response below. */
function AskingWidgetVisual() {
    return (
        <div className="flex flex-col gap-3 border border-on-background rounded-xs bg-background p-5 shadow-[0_18px_36px_-24px_rgba(0,50,32,0.18)] min-h-[298px]">
